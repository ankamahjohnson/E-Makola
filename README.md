# E-Makola 
A fully functional e-commerce web app with Paystack API integration built to sell gadgets to millennials and Gen-Z consumers across Africa, featuring a complete shopping cart system, live payment method (Momo & Banking visa card), light/dark mode, & persistent data using localStorage.
...
## Features
### 🛍️ Product Discovery
- 18 quality products across 6 categories
...
- Remove products directly from the landing page
- Real-time cart button counter
- Persistent cart saved in localStorage (survives page refresh)
- Fully featured cart modal:
...
- Beautiful landing page with four structured sections
- Toast notifications for every action (add to cart, remove, success, etc.)
...
- Clean grid layout on tablets & desktops
