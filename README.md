# E-Makola 
A fully functional e-commerce web app with Paystack API integration built to sell gadgets to millennials & Gen-Z consumers across Africa, featuring a complete shopping cart system, live payment method (Momo and Banking visa card), light/dark mode, and persistent data using localStorage.
